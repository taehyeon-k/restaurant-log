...
export default function PlaceScreen({
  ...
  return (
    <div className="absolute inset-0 z-[1200] bg-paper">
      <button
        type="button"
        onClick={onBack}
        aria-label="뒤로"
        className="absolute left-4 z-[3] grid size-11 cursor-pointer place-items-center rounded-full border-none bg-[rgba(251,250,246,.92)] text-[17px] text-ink"
        style={{ top: SAFE_TOP }}
      >
        ←
      </button>
